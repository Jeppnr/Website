...
<html lang="en">
  <head>
    ...
    <link rel="assets/stylesheet" href="assets/css/open-iconic-bootstrap.min.css">
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="index.html">My Portfolio</a></h1>
		...
		<div id="colorlib-main">
			<div class="hero-wrap js-fullheight" style="background-image: url(assets/images/keyboard3.jpg);" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <p>I studied at City College of Calamba</p>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-12">
    				<div class="blog-entry ftco-animate">
							<a href="#" class="img img-2" style="background-image: url(assets/images/ccc.jpg);"></a>
							<div class="text text-2 pt-2 mt-3">
								<h3 class="mb-4"><a href="#">City College of Calamba</a></h3>
